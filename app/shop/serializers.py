...
class OrderSerializer(serializers.ModelSerializer)  :
    ...
    class Meta:
        model = models.Order
        fields = ['id', 'user', 'email', 'order', 'personal_info_used', 'delivery_instructions', 'delivery_status', 'date_ordered', 'total_price']
...
class UserDeliveryInfoSerializer(serializers.ModelSerializer)  :
    ...
    class Meta:
        ...
        fields = ['id', 'user', 'first_name', 'last_name','email', 'phone_number', 'address', 'city', 'country', 'post_code', 'delivery_type']
